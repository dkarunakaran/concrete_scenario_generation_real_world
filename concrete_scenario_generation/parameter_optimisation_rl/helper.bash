...
client_docker_i=generation_i
client_docker_c=generation_c
...
if [[ $1 == "build_client_c" ]]; then
	if [[ $2 == "laptop" ]]; then
  		docker run --net=host -d -v=/home/beastan/Documents/phd/scenario_extraction/concrete_scenario_generation/parameter_optimisation_rl:/generation --name $client_docker_c $client_docker_i
	fi
fi
