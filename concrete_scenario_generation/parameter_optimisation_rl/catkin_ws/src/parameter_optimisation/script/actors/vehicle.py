...
class Vehicle:
    ...
    def __init__(self, client = None, world = None, spawn_points = None, long_pos = None):
        ...
        self.role_name = parameter_config['vehicle']['name']
        self.actor_filter = parameter_config['vehicle']['model']
        self.sensor_actors = []
        ...
        self.blueprint.set_attribute('color', '191, 10, 48')
        self.spawn_point = None
        self.sensor_definition_file = rospy.get_param('sensor_definition_file')
        self.initial_spawn_point = parameter_config['vehicle']['initial_spawn_point']
    ...
    def set_spawn_point(self):
        ...
        self.spawn_point.location.x += self.long_pos
