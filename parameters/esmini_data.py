...
if sys.platform == "linux" or sys.platform == "linux2":
    se = ctypes.CDLL("/home/beastan/Documents/phd/scenario_extraction/parameters/esmini-bin_ubuntu/bin/libesminiLib.so")
else:
...
for _file in _dir:
    ...
    if fileDetails[1] == '.cutin' or fileDetails[1] == '.cutout':
        ...
        for param in file_data['parameter']: 
            ...
            # 3 - adding 2 m/s #4
            # 2 - adding 4 m/s
            param_cut_time = param['param_adv_to_cut_start_time']
                    ...
                    for j in range(se.SE_GetNumberOfObjects()):
                        ...
                        if j == 1:
                            ...
                            if adv_prev_t == None:
                                ...
                                if param_cut_time in other_traj:
