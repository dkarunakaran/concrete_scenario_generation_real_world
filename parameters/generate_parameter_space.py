...
class GenerateParamterSpace:
    def __init__(self):
        self.save_loc = '/home/beastan/Documents/phd/scenario_extraction/parameters/dataset/parameter_space/'
        self.cut_in = {
...
if __name__ == '__main__':
    ...
    loc = '/home/beastan/Documents/phd/scenario_extraction/parameters/scenario_data_all/'
    _dir = os.listdir(loc)
    for _file in _dir:
